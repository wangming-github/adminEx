package com.adminex.common.security.filter;


import com.adminex.common.core.content.Content;
...
import com.adminex.common.security.entity.User;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public TokenLoginFilter(AuthenticationManager authenticationManager, TokenManager tokenManager, RedisTemplate redisTemplate) {
        ...
        this.setRequiresAuthenticationRequestMatcher(new AntPathRequestMatcher("/adminex/acl/login", "POST"));
    }
